...
class FormHelper {
    ...
    public function button($type = 'button', $attributes = array()) {
        if (!in_array(strtolower($type), ["button", "submit", "reset"]))
            throw new Exception("Type for tag <Button> is invalid : ".$type);
